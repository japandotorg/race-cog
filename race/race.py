...
class Race(commands.Cog):
    ...
    async def start(self, ctx: commands.Context):
        ...
        elif ctx.author == self.bot.is_owner(ctx.author):
    ...
    async def run_game(self, ctx):
        ...
        setup = "\u200b\n" + "\n".join(
            f"<a:melon_lavender:1070060245839265873> **{animal.current}** <a:prideflag:892003790339858462>[{jockey.display_name}]" for animal, jockey in players
        )
        ...
        while not all(animal.position == 0 for animal, jockey in players):
            ...
            for animal, jockey in players:
                if animal.position == 0:
                    fields.append(f"<a:melon_lavender:1070060245839265873> **{animal.current}** <a:prideflag:892003790339858462>  [{jockey.display_name}]")
                    continue
                animal.move()
                fields.append(f"<a:melon_lavender:1070060245839265873> **{animal.current}** <a:prideflag:892003790339858462>  [{jockey.display_name}]")
